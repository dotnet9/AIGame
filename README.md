...
一款面向 3-6 年级小朋友的 **3D 英语学习游戏**：在一座漂浮的大岛上（农场、海滩、森林三大场景），念出英文单词唤醒"词宠蛋"，孵出来的词宠会成为伙伴——**读懂谜题、召唤**它们解谜开路，它们饿了还会找你**复习**（遗忘曲线伪装成喂养）。
...
## 🗺️ 词宠大岛（60 词 · 10 关 · 三大场景）

**关卡制**：每唤醒 6 只词宠通关一次，庆祝后下一关的蛋才出现。剧情钥匙（boat/light/wind/seed/rain）固定钉在对应关卡，永远不会有卡死的关。
...
词库对齐人教版 PEP 3-6 年级；第 7-10 关的谜题会复用已孵化的词宠（wind/banana），顺便完成一轮复习。

**画面小剧场**：蛋有天空光柱和环绕小星星；喂对词宠会飞出爱心；跑步扬起小尘土、魔法棒撒星星；草甸有蝴蝶、海滩有海鸥盘旋、森林里有萤火虫；环岛是会呼吸的浪花圈；集齐 60 只词宠有全屏烟花秀。评分喝彩（PERFECT!/GREAT!…）是**带情绪的童声**，喝彩大字会在弹窗外飘起、升高、消失。
